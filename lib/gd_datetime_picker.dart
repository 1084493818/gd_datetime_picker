...
import 'package:gd_datetime_picker/src/date_model.dart';
import 'package:gd_datetime_picker/src/datetime_picker_theme.dart';
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? GDDatePickerTheme(),
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    GDDatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(GDDatePickerTheme theme) {
  ...
  Widget _renderItemView(GDDatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(GDDatePickerTheme theme) {
...
///自动生成的代码
class GdDatetimePicker {
  Future<String?> getPlatformVersion() {
    return GdDatetimePickerPlatform.instance.getPlatformVersion();
  }
}
